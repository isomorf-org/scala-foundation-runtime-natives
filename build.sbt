...
//useGpg := true,
  homepage   := Some(url("https://github.com/isomorf-org/scala-foundation-runtime-natives")),
  scmInfo    := Some(ScmInfo(url("https://github.com/isomorf-org/scala-foundation-runtime-natives"),
                              "git@github.com:isomorf-org/scala-foundation-runtime-natives.git")),
